...
describe('TC014: Kiểm tra lọc đa điều kiện', function () {
    this.timeout(120000);
    let driver;
    ...
    it(`TC014 - Chọn Pin trâu: trên 5500 mAh, RAM ${data.module3.filterRam}, Hỗ trợ mạng ${data.module3.filter5G}`, async function () {
        ...
        let filename = await takeScreenshot(driver, this.test.title, 'tc014');
