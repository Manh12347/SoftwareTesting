...
describe('TC015: Kiểm tra sắp xếp sản phẩm theo giá', function () {
    this.timeout(60000);
    let driver;
    ...
    it(`TC015 - Nhấn "${data.module3.sortText}" - sản phẩm hiển thị đúng thứ tự`, async function () {
        ...
        let filename = await takeScreenshot(driver, this.test.title, 'tc015');
