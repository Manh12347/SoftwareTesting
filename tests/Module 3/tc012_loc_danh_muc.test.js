...
describe('TC012: Kiểm tra lọc sản phẩm theo danh mục', function () {
    this.timeout(60000);
    let driver;
    ...
    it('TC012 - Hover vào "Danh mục" rồi click "Điện thoại"', async function () {
        ...
        const filename = await takeScreenshot(driver, this.test.title, 'tc012');
