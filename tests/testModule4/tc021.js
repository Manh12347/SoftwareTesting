...
describe('TC021: Đặt hàng QR code và đợi 15 phút (Kiểm tra hết hạn giao dịch)', function () {
    ...
    afterEach(async function () {
        const screenshotPath = await takeScreenshot(driver, this.currentTest.title, 'tc021');
        addContext(this, {
